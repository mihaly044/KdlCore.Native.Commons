...
{
	public static class NtStatusEx
	{
		/// <summary>
		/// Returns true if the <paramref name="status"/> value indicates success.
		/// This function is identical to the behaviour of the <seealso cref="NT_SUCCESS"/> macro in C++.
		/// </summary>
